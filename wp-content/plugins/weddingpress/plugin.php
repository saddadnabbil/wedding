...
$license_status = get_option( 'weddingpress_license_status' ); if ( isset( $license_status->license ) && $license_status->license == 'valid' ) : if ( did_action( 'elementor/loaded' ) ) {include_once( WEDDINGPRESS_ELEMENTOR_PATH . '/extensions/sticky.php' ); include_once( WEDDINGPRESS_ELEMENTOR_PATH . '/elementor/elementor.php' ); } endif;
