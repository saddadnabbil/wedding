...
class WDP_Elementor {
    ...
    public function enqueue_elementor_editor_scripts() {
        ...
        wp_enqueue_script( $this->plugin_name . '-elementor-editor', WEDDINGPRESS_ELEMENTOR_WEB .
            'assets/js/elementor-editor.min.js', array( 'elementor-editor' ), $this->version, true );
